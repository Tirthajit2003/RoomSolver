...
export default function UpdateListing() {
    ...
    useEffect(()=>{
        const fetchListing=async()=>{
            ...
            const res=await fetch(`/api/listing/get/${listing_id}`);
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semicbold text-center my-7'>Update a Listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1'>
                ...
                <button disabled={uploading || loading}className='p-3 bg-blue-700 text-white rounded-lg hover:opacity-95 disabled:opacity-80'>{loading? 'Updating...':'Update Listing'}</button>
