  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        <img  className="rounded-full self-center h-24 w-24 object-cover cursor-pointer mt-2 " src={currentUser.avatar} alt="profile" />
        ...
        <button className='bg-blue-500 text-white p-3 rounded-lg hover:opacity-95 disabled:opacity-80'>Update</button>
